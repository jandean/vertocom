...
<footer class="siteFoot">
    ...
    <div class="copyright">
        COPYRIGHT &copy; 2013 LIBERTY COMMODITIES CORPORATION
    </div>
</footer>
...
<script type="text/javascript">
    ...
    function mce_init_form(){
        jQuery(document).ready( function($) {
          ...
          options = { url: 'http://themayakitchen.us3.list-manage1.com/subscribe/post-json?u=093befd519c5e89568e2f86e9&id=cdf613aa70&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
